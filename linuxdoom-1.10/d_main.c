...
void D_Display (void)
{
    ...
    {
	wipe = true;
	if (!v_32bit) wipe_StartScreen(0, 0, SCREENWIDTH, SCREENHEIGHT);
    }
    else
	wipe = false;
    ...
    // wipe update
    if (!v_32bit) wipe_EndScreen(0, 0, SCREENWIDTH, SCREENHEIGHT);
	...
	do
	{
	    ...
	    wipestart = nowtime;
				   ...
				   , 0, 0, SCREENWIDTH, SCREENHEIGHT, tics * SCREENHEIGHT / ID_SCREENHEIGHT);
	    I_UpdateNoBlit ();
